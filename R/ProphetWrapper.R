...
#' @param judgmental_forecasts A names vector with the date as name and the value of the judmental forecast. For example if we know in advance that on the Xmas day the value we are trying to predict is zero we can parse judgmental_forecasts = c('2016-12-25' = 0,  '2017-12-25' = 0, '2018-12-25' = 0).
